defmodule YTD.Athletes.CalculationsTest do
  use ExUnit.Case
  alias YTD.Athletes.Calculations
  doctest Calculations

  describe "YTD.Athletes.Calculations.projected_annual/2" do
  ...
  describe "YTD.Athletes.Calculations.weekly_average/2" do
  ...
  describe "YTD.Athletes.Calculations.on_target?/3" do
  ...
  describe "YTD.Athletes.Calculations.estimated_target_completion/3" do
  ...
  describe "YTD.Athletes.Calculations.required_average/3" do
