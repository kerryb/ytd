defmodule YTD.Core.CalculationsTest do
  use ExUnit.Case
  alias YTD.Core.Calculations
  doctest Calculations

  describe "YTD.Core.Calculations.projected_annual/2" do
  ...
  describe "YTD.Core.Calculations.weekly_average/2" do
  ...
  describe "YTD.Core.Calculations.on_target?/3" do
  ...
  describe "YTD.Core.Calculations.extra_needed_today/3" do
  ...
  describe "YTD.Core.Calculations.extra_needed_this_week/4" do
  ...
  describe "YTD.Core.Calculations.estimated_target_completion/3" do
